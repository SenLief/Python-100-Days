...
![](../.gitbook/assets/baidu-search-taobao.png)
...
![](../.gitbook/assets/http-request%20%282%29.png)

HTTP响应（响应行+响应头+空行+消息体）：

![](../.gitbook/assets/http-response%20%282%29.png)
...
1. Chrome Developer Tools：谷歌浏览器内置的开发者工具。
   ...
   ![](../.gitbook/assets/chrome-developer-tools.png)
...
![](../.gitbook/assets/crawler-workflow.png)
