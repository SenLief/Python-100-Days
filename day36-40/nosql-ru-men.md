...
![](../.gitbook/assets/redis-bind-and-port.png)

配置底层有多少个数据库。

![](../.gitbook/assets/redis-databases.png)

配置Redis的持久化机制 - RDB。

![](../.gitbook/assets/redis-rdb-1.png)

![](../.gitbook/assets/redis-rdb-3.png)

配置Redis的持久化机制 - AOF。

![](../.gitbook/assets/redis-aof.png)

配置访问Redis服务器的验证口令。

![](../.gitbook/assets/redis-security.png)

配置Redis的主从复制，通过主从复制可以实现读写分离。

![](../.gitbook/assets/redis-replication.png)

配置慢查询。

![](../.gitbook/assets/redis-slow-logs.png)
...
![](../.gitbook/assets/redis-data-types.png)
